...
const StepperDescriptionWrapper = ({ description }: { description?: string }) => {
  ...
  return (
    <Stepper.Description
      render={(domProps) => (
        <p className="text-muted-foreground text-sm" {...domProps}>
          {description}
        </p>
      )}
    />
...
const StepperSeparatorWithStatus = ({
  ...
  return (
    <Stepper.Separator
      ...
      data-status={status}
      className="bg-muted data-[status=success]:bg-primary transition-all duration-300 ease-in-out data-disabled:opacity-50 data-[orientation=horizontal]:h-0.5 data-[orientation=horizontal]:flex-1"
    />
  );
};
...
function CompleteStep({
  ...
  return (
    <div className="space-y-4">
      <div className="bg-secondary space-y-3 rounded border p-4">
      ...
      {({ stepper }) => {
        ...
        return (
          <>
            ...
            <div className="bg-card min-h-70 rounded border p-6">
              {stepper.flow.switch({
                personal: () => (
                  <PersonalInfoForm
